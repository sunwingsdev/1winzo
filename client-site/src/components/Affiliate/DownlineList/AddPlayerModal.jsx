...
const AddPlayerModal = ({ isOpen, onClose, formData, onChange, onSubmit }) => {
  ...
  return (
    ...
    >
      <div className="flex justify-center items-start mr-24 mt-7">
        <div className="bg-bgModalColor  rounded-lg w-full max-w-[410px] p-4 pb-16 shadow-lg"
        ...
        >
          ...
          <div className="flex justify-center mt-4">
            <div
              ...
              onClick={onSubmit}
            >
              <button className="text-xs text-black py-[7px] font-medium w-full">
                Create
              </button>
            </div>
          </div>
