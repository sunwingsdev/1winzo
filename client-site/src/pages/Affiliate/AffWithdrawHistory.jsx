...
const AffWithdrawHistory = () => {
  ...
  const filteredWithdraws = allWithdraws?.filter(
    (withdraw) => withdraw.parentId === user?._id
  );
  const sortedWithdraws = filteredWithdraws
    ? [...filteredWithdraws].sort(
...
export default AffWithdrawHistory;
